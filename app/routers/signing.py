    ...
    try:
        ...
        if all_signed:
            ...
            try:
                ...
                # We could raise here to let the user know, but for now we swallow to return success for signing step
                raise HTTPException(status_code=500, detail=f"Error burning PDF: {str(e)}")
